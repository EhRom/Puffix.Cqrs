...
namespace Puffix.Cqrs.Repositories.Handlers
{
    ...
    public class ModificationEventHandler<AggregateT, IndexT> : IModificationEventHandler<AggregateT, IndexT>
        ...
        where IndexT : IComparable, IComparable<IndexT>, IEquatable<IndexT>
    {
        ...
        public ModificationEventHandler(IRepository<AggregateT, IndexT> repository)
        {
        ...
        public async Task HandleAsync(AggregateT aggregate, IModificationEvent<AggregateT, IndexT> handledEvent)
        {
